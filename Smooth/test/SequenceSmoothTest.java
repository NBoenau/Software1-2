...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <1, 2147483645> and s2 = <1, 2, 3>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(1, 2147483645);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1, 2147483645);
    ...
    /**
     * Test smooth with s1 = <-2147483645, 1> and s2 = <1, 2, 3>.
     */
    @Test
    public void test4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-2147483645, 1);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-2147483645, 1);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-1073741822);
        /*
         * SequenceSmooth.smooth(seq1, seq2);
         *
         * Assert that values of variables match expectations
    ...
    /**
     * Test smooth with s1 = <-2147483645, 2147483645> and s2 = <1, 2, 3>.
     */
    @Test
    public void test5() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-2147483645, 2147483645);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-2147483645,
                2147483645);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
    ...
    /**
     * Test smooth with s1 = <-10, 2, 8> and s2 = <1, 2, 3>.
     */
    @Test
    public void test6() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-10, 2, 8);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-10, 2, 8);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-4, 5);
        /*
         * SequenceSmooth.smooth(seq1, seq2);
         *
         * Assert that values of variables match expectations
    ...
    /**
     * Test smooth with s1 = <0, 50, 78> and s2 = <1, 2, 3>.
     */
    @Test
    public void test7() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(0, 50, 78);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0, 50, 78);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(25, 64);
        /*
         * SequenceSmooth.smooth(seq1, seq2);
         *
         * Assert that values of variables match expectations
